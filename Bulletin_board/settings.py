...
SECRET_KEY = 'django-insecure-2eql)cup(@p2f#erj8i3efi^z$8hjt+=u-*v(6*v0c(*2gv1rf'
...
TINYMCE_DEFAULT_CONFIG = {
    'height': 700,  # Высота редактора в пикселях
    'width': '100%',  # Ширина редактора
    'menubar': '',  # Меню в редакторе
    'plugins': 'image media',  # Подключаемые плагины
    'toolbar': 'image media',  # Инструменты в панели редактора
    'statusbar': False,  # Показывать нижнюю панель с информацией
}
